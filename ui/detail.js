...
const FLOW_INTEGRATIONS = [
  ...
  { id: 'aws', name: 'AWS', kind: 'both', keys: ['aws_get_cost_and_usage', 'aws_get_cost_forecast', 'aws_list_dimension_values', 'aws_s3_put_object', 'aws_s3_get_object', 'aws_s3_list_objects', 'cost explorer', 'amortizedcost', 'unblendedcost', 's3://'],
    readKeys: ['aws_get_cost_and_usage', 'aws_get_cost_forecast', 'aws_list_dimension_values', 'aws_s3_get_object', 'aws_s3_list_objects', 'cost explorer', 'amortizedcost', 'unblendedcost'],
